...
HD_PWD='/home/keith/xilProjects/artyFTDI/artyFTDI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uartFTDI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uartFTDI.tcl
